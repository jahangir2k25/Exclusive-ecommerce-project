...
const ThirdHead = ({ items, count, heading, className }) => {
    return (
        <>
            <div>
                <div className={`${className} border-2 border-secondary hover:bg-primary hover:text-white duration-300 ease-linear w-42.5 h-36.25 text-center rounded-sm mx-auto`}>
